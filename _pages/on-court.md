...
layout: default
title: On Court
permalink: /beyond-research/on-court/
section: on-court
kicker: Basketball & Badminton
---
...
<div class="beyond-module">
  <header class="beyond-module__hero">
    ...
    <p>{{ page.kicker }}</p>
    <h1>{{ page.title }}</h1>
    <div>Basketball, badminton, teammates, and time spent moving. This collection can hold team photographs, a match or training memory, and the ordinary joy of playing.</div>
  </header>

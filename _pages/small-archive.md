...
layout: default
title: Small Archive
permalink: /beyond-research/small-archive/
section: small-archive
kicker: Things Kept Close
---
...
<div class="beyond-module">
  <header class="beyond-module__hero">
    ...
    <p>{{ page.kicker }}</p>
    <h1>{{ page.title }}</h1>
    <div>Music, films, objects, places, and moments that resist a tidy category. This is the most open collection: a small archive for the things I do not want to forget.</div>
  </header>
